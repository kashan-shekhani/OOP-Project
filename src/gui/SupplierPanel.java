...
public class SupplierPanel extends JPanel {
    ...
    private JPanel createTablePanel() {
        ...
        panel.setBorder(BorderFactory.createTitledBorder("Supplier List"));
    ...
    private void addSupplier() {
        ...
        try (Connection conn = DatabaseConnection.getConnection();
             PreparedStatement pstmt = conn.prepareStatement(
                 "INSERT INTO Suppliers (Name, Contact, Address, CNIC) VALUES (?, ?, ?, ?)",
            ...
            try (ResultSet rs = pstmt.getGeneratedKeys()) {
                if (rs.next()) {
                    ...
                    // Refresh supplier lists in other panels
                    Window window = SwingUtilities.getWindowAncestor(this);
                    if (window instanceof MainForm) {
                        MainForm mainForm = (MainForm) window;
                        mainForm.getTransactionPanel().refreshSuppliers();
                        mainForm.getInventoryPanel().refreshSuppliers();
                    }
                }
            }
        } catch (SQLException e) {
    ...
    private void deleteSelectedSupplier() {
        ...
        if (confirm == JOptionPane.YES_OPTION) {
            try (Connection conn = DatabaseConnection.getConnection();
                ...
                suppliers.removeIf(s -> s.getId() == supplierId);
